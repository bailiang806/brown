package com.happydriving.rockets.server.component.alipay.util;
...
import com.happydriving.rockets.server.component.alipay.util.httpClient.HttpProtocolHandler;
import com.happydriving.rockets.server.component.alipay.util.httpClient.HttpRequest;
import com.happydriving.rockets.server.component.alipay.util.httpClient.HttpResponse;
import com.happydriving.rockets.server.component.alipay.util.httpClient.HttpResultType;
import com.happydriving.rockets.server.component.alipay.sign.MD5;
...
public class AlipaySubmit {
    ...
    public static String buildRequestUrl(Map<String, String> sParaTemp) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
        TreeMap<String, String> sortedParas = new TreeMap<>(sPara);
        return AlipaySubmit.ALIPAY_GATEWAY_NEW+AlipayCore.createLinkString(sortedParas);
    }
