    ...
    $.extend({
        ...
        showMap: function (options) {
            ...
            $.each(schoolLocations, function (m, drivingSchool) {
                ...
                var label = new BMap.Label("<a id='"+drivingSchool.id+"' style='color:#ffffff;text-decoration:none' href='#schooldetail/"+drivingSchool.id+"'>" + drivingSchool.schoolName + "</a>",
                    {
